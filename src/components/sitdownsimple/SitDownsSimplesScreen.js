...
import { PaginatedSitDownsSimplesItems } from "./PaginatedSitDownsSimplesItems";

export const SitDownsSimplesScreen = () => {
  ...
  return (
    <div className="d-flex flex-column justify-content-center align-items-center text-center">
      ...
      {entradas.length > 0 ?
        <PaginatedSitDownsSimplesItems itemsPerPage={10} items={entradas} loading={loading} />
        :
